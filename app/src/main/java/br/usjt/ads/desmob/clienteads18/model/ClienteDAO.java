...
public class ClienteDAO {
    ...
    public static Cliente[] getClientes(){
        if(clientes == null){
            ...
            clientes[0] = new Cliente(1, "o resgate do soldado ryan", "d171215", "Steven Spielberg", "05/03/1999");
            clientes[1] = new Cliente(2,"A Ponte do Rio Kwai","ponte", "David Lean"  , "23/12/1957");
            clientes[2] = new Cliente(3,"Lawrence da Arábia","lawrence", "David Lean", "11/02/1963");
            clientes[3] = new Cliente(4,"O Poderoso Chefão","chefao", "Francis Ford Coppola"  , "22/12/1995");
            ...
            clientes[19] = new Cliente(20,"Dragon Ball Super: Broly","", "Tatsuya Nagamine"  , "14/12/2018");
